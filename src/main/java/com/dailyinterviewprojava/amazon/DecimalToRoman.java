 ...
 * Typically the digits are listed from largest to smallest, so X should always come before I. 
 * Thus the largest possible digits should be used first before the smaller digits (so to represent 50, instead of XXXXX, we should use L).
 * 
